...
const Header = () => {
    ...
    const mobileMenuClasses = `flex item-start flex-col gap-y-12 fixed top-20 p-12 bg-white rounded-3xl shadow-md w-64 medium-16 ring-1 ring-slate-900/5 transition-all duration-300 ${menuOpened ? "right-8" : "-right-[100%]"}`;
    ...
    return (
        <header className="fixed top-0 left-0 m-auto max_padd_container w-full bg-white ring-1 ring-slate-900/5 z-10">
            <div className="px-4 flexBetween py-3 max-x5:px-2">
                ...
                {/* Navbar Mobile */}
                {menuOpened && <Navbar containerStyles={mobileMenuClasses} />}
